# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-10-02 08:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_at', models.DateTimeField(auto_now=True, null=True)),
                ('song', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='songlyrics.Song')),
        ...
        migrations.AddField(
            model_name='favor',
            name='song',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='songlyrics.Song'),
        ),
        migrations.AddField(
            model_name='favor',
            name='user',
